        ...
        <div class="text-right col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="borrows" id="basic_data" method="post" action="<?php echo e(url("/borrows/add")); ?>" enctype="multipart/form-data">
        ...
        <div class="myContainer text-right col-xs-12">
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <form id="search_form" name="borrows" action="<?php echo e(url("borrows/search")); ?>" class="form-group ">
                ...
                <div class="myTable table-responsive">
                  <table class="table text-center table-bordered table-striped table-hover table-condensed">
                    ...
                    <tr>
                      <td class="hidden-print">
                        <a name="delete" class="text-primary text-center" href="borrows/delete/<?php echo e($borrow->number); ?>"><i title="حذف" class="fa fa-trash"></i></a>
                      </td>
                      <td class="hidden-print">
                          <a name="edit" class="text-primary text-center" href="/borrows/get/borrow/<?php echo e($borrow->number); ?>"><i title="تعديل" class="fa fa-edit"></i></a>
                      </td>
                      <td class=""><?php echo e($borrow->emp_national_number); ?></td>
                      <td class=""><?php echo e($borrow->total_amount); ?></td>
                      <td class=""><?php echo e($borrow->benefits); ?></td>
                      <td class=""><?php echo e($borrow->description); ?></td>
                  ...
                  <div>
                  <a href="https://www.google.com/maps/@29.1843342,31.1336,18z">موقعنا</a>
                  </div>
                </div>
              </div>
          </div>
