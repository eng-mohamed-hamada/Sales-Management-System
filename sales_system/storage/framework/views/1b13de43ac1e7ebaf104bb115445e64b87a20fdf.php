        ...
        <div class="text-right col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="installments" id="basic_data" method="post" action="<?php echo e(url("/installments/add")); ?>" enctype="multipart/form-data">
        ...
        <div class="myContainer text-right col-xs-12">
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <form id="search_form" name="installments" action="<?php echo e(url("installments/search")); ?>" class="form-group ">
