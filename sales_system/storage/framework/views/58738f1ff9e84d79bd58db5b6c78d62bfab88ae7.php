        ...
        <div class="text-right col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form name="costs" id="basic_data" method="post" action="<?php echo e(url("/costs/add")); ?>" enctype="multipart/form-data">
        ...
        <div class="myContainer text-right col-xs-12">
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <form id="search_form" name="costs" action="<?php echo e(url("costs/search")); ?>" class="form-group ">
                  ...
                  <table class="table text-center table-bordered table-striped table-hover table-condensed">
                    ...
                    <tr>
                      <td class="hidden-print">
                        <a name="delete" class="text-primary text-center" href="costs/delete/<?php echo e($cost->number); ?>"><i title="حذف" class="fa fa-trash"></i></a>
                      </td>
                      <td class="hidden-print">
                          <a name="edit" class="text-primary text-center" href="/costs/get/cost/<?php echo e($cost->number); ?>"><i title="تعديل" class="fa fa-edit"></i></a>
                      </td>
                      <td class=""><?php echo e($cost->status); ?></td>
                      <td class=""><?php echo e($cost->description); ?></td>
                      <td class=""><?php echo e($cost->amount); ?></td>
                      <td class=""><?php echo e($cost->cost_date); ?></td>
                      <td class=""><?php echo e($cost->number); ?></td>
                    </tr> 
