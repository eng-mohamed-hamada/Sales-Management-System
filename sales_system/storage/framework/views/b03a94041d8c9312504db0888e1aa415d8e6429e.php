        ...
        <div class="text-right col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="departments" id="basic_data" method="post" action="<?php echo e(url("/departments/add")); ?>" enctype="multipart/form-data">
        ...
        <div class="myContainer text-right col-xs-12">
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <form id="search_form" name="departments" action="<?php echo e(url("departments/search")); ?>" class="form-group ">
                  ...
                  <table class="table text-center table-bordered table-striped table-hover table-condensed">
                    ...
                    <tr>
                      <td class="hidden-print">
                        <a name="delete" class="text-primary text-center" href="departments/delete/<?php echo e($department->number); ?>"><i title="حذف" class="fa fa-trash"></i></a>
                      </td>
                      <td class="hidden-print">
                          <a name="edit" class="text-primary text-center" href="/departments/get/department/<?php echo e($department->number); ?>"><i title="تعديل" class="fa fa-edit"></i></a>
                      </td>
                      <td class=""><?php echo e($department->name); ?></td>
                      <td class=""><?php echo e($department->number); ?></td>
                    </tr> 
