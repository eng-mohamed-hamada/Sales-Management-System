        ...
        <div class="text-right col-xs-12">
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                  ...
                  <form name="sales" id="bell" method="post" action="<?php echo e(url("/admin/sales/create/bell")); ?>" enctype="multipart/form-data">
        ...
        <div class="text-right col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form name="sales" id="bell_products" method="post" action="<?php echo e(url("/admin/sales/add")); ?>" enctype="multipart/form-data">
                      <div class="form-group">
                      <input id="_token" name="_token" type="hidden" value="<?php echo e(csrf_token()); ?>">
                      </div>  
                      ...
                      <form id="search_form" name="sales" action="<?php echo e(url("admin/sales/search")); ?>" class="">
