        ...
        <div class="text-right col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="suppliers" id="basic_data" method="post" action="<?php echo e(url("/suppliers/add")); ?>" enctype="multipart/form-data">
        ...
        <div class=" text-right col-xs-12">
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <form id="search_form" name="suppliers" action="<?php echo e(url("suppliers/search")); ?>" class="form-group ">
                      ...
                      <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="hidden-print">
                                <a name="delete" class="text-primary text-center" href="suppliers/delete/<?php echo e($supplier->number); ?>"><i title="حذف" class="fa fa-trash"></i></a>
                            </td>
                            <td class="hidden-print">
                                <a name="edit" class="text-primary text-center" href="/suppliers/get/supplier/<?php echo e($supplier->number); ?>"><i title="تعديل" class="fa fa-edit"></i></a>
                            </td>
                            <td><?php echo e($supplier->whatsapp_phone); ?></td>
                            <td><a href="<?php echo e($supplier->facebook_url); ?>"><?php echo e($supplier->facebook_url); ?></a></td>
                            <td><a href="<?php echo e($supplier->app_url); ?>"><?php echo e($supplier->app_url); ?></a></td>
                            <td><?php echo e($supplier->address); ?></td>
                            <td><?php echo e($supplier->name); ?></td>
                            <td><?php echo e($supplier->phone); ?></td>
                            <td><?php echo e($supplier->number); ?></td>
                        </tr>
