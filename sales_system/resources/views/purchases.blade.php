        ...
        <div class="text-right col-xs-12">
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                  ...
                  <form name="purchases" id="bell" method="post" action="{{url("/purchases/create/bell")}}" enctype="multipart/form-data">
        ...
        <div class="text-right col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form name="purchases" id="bell_products" method="post" action="{{url("/purchases/add")}}" enctype="multipart/form-data">
                      <div class="form-group">
                      <input id="_token" name="_token" type="hidden" value="{{csrf_token()}}">
                      </div>  
                      ...
                      <form id="search_form" class="col-xs-12" name="purchases" action="{{url("purchases/search")}}" class=" ">
